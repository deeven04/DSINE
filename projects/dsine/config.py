...
def get_args(test=False):
    ...
    file_path = './experiments/exp001_cvpr2024/dsine.txt'
    assert '.txt' in file_path
    arg_filename_with_prefix = '@' + file_path
    ...
    #↓↓↓↓
    #NOTE: update args
    args.exp_root = os.path.join("/Users/deeven/Desktop/portrait_prj/DSINE-main/projects/", 'dsine')
    # print(args.exp_root)
    # print("\n\n\n")
    ...
    # print(f"/t/t/tCreating directory: {exp_dir}/t/t/t")
